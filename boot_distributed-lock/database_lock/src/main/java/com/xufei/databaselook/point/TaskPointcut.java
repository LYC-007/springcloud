package com.xufei.databaselook.point;

import com.xufei.databaselook.model.MethodLock;
import com.xufei.databaselook.repository.MethodLockRepository;
...
public class TaskPointcut {
     ...
     */
    @Pointcut("execution(public * com.xufei.databaselook.controller.OrderController.*(..)))")
